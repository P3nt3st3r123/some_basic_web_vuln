...
## Now, we need to figure out what d and h are, from tmp2 and tmp3.
	...
	def padding(self, m, force_length_mess=None):
		lm = force_length_mess if force_length_mess else len(m)
	...
	def sha256_raw(self, m, round_keys = None):
		...
		for i in range(0, len(m), 64):## loop 1 time b'Encoded with random keys\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xc0'
			block = m[i:i + 64]
	...
	def sha256(self, m, round_keys = None, force_length_mess=None):
		m_padded = self.padding(m,force_length_mess) # first get padding mess
